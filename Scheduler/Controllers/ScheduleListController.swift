...
class ScheduleListController: UIViewController {
    ...
    private func showCreateEventVC(_ event: Event? = nil) { // _ event: Event? = nil default parameter
        ...
        // let createEC = CreateEventController() - creates an empty view controller without any outlets, etc.
        // Will crash if you are expecting your outlets to work if they exist in the storyboard.
